...
data Face = FTop | FBottom | FLeft | FRight | FFront | FBack deriving Show

faceOf :: Heading -> Face -> Face
faceOf HRight FTop = FRight
faceOf HDown FTop = FFront
faceOf HLeft FTop = FLeft
faceOf HUp FTop = FBack
faceOf HRight FBottom = FRight
faceOf HDown FBottom = FBack
faceOf HLeft FBottom = FLeft
faceOf HUp FBottom = FFront
faceOf HRight FLeft = FFront
faceOf HDown FLeft = FBottom
faceOf HLeft FLeft = FBack
faceOf HUp FLeft = FTop
faceOf HRight FRight = FBack
faceOf HDown FRight = FBottom
faceOf HLeft FRight = FFront
faceOf HUp FRight = FTop
faceOf HRight FFront = FRight
faceOf HDown FFront = FBottom
faceOf HLeft FFront = FLeft
faceOf HUp FFront = FTop
faceOf HRight FBack = FLeft
faceOf HDown FBack = FBottom
faceOf HLeft FBack = FRight
faceOf HUp FBack = FTop
